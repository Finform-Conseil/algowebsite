...
const AfricaOPCVMMap: React.FC<AfricaOPCVMMapProps> = ({
  ...
  const getCountryColor = (countryId: string) => {
    const exchange = stockExchanges.find((ex) =>
      ex.countries.includes(countryId)
    );
    if (!exchange) return "var(--card-background)";
    return getColorForExchange(exchange.id);
  };
            ...
            {stockExchanges.map((exchange) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{
                    delay: 0.5 + stockExchanges.indexOf(exchange) * 0.1,
                    type: "spring",
                  }}
                  ...
                  >
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          getColorForExchange(exchange.shortName || "") ||
                          "#10B981",
                        top: "-35%",
                        left: "-35%",
                        transform: "translate(-50%, -50%)",
