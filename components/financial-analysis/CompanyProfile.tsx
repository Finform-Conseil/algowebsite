...
export default function CompanyProfile({ action, profile }: CompanyProfileProps) {
  return (
    <div className="company-profile">
      ...
      <div className="profile-section">
        ...
        <p className="description-text">{action?.society.description ?? "--"}</p>
      </div>

      {/* Organigramme / Structure */}
      {(action?.society.parent || (action?.society.subsidiaries && action?.society.subsidiaries.split(',').length > 0)) && (
        <div className="profile-section">
          ...
          <div className="org-chart">
            {action?.society.parent && (
              <div className="org-level parent">
                <div className="org-node">
                  ...
                  <span>{action?.society.parent.name}</span>
                </div>
            ...
            <div className="org-level current">
              <div className="org-node highlight">
                ...
                <span>{action?.society.name}</span>
              </div>
            </div>

            {action?.society.subsidiaries && action?.society.subsidiaries.split(', ').length > 0 && (
              <>
                <div className="org-connector"></div>
