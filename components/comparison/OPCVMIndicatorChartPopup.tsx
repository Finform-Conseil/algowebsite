...
interface OPCVMIndicatorChartPopupProps {
...
export default function OPCVMIndicatorChartPopup({ indicator, opcvms, children }: OPCVMIndicatorChartPopupProps) {
  ...
  useEffect(() => {
    ...
    // Bar Chart only
    const data = opcvms.map((opcvm, index) => {
