// src/core/presentation/components/pages/Widget/TechnicalAnalysis/lib/strategies/renderers/ChartPatterns/CypherPatternRenderer.ts
...
export function renderCypher(
    ...
    ctx.globalAlpha = 0.6;
    if (n >= 3) drawDiagonalWithRatio(pixelPoints[0], pixelPoints[2], dataPoints[0], dataPoints[1], dataPoints[2], "XC", helpers);
    if (n >= 4) drawDiagonalWithRatio(pixelPoints[1], pixelPoints[3], dataPoints[0], dataPoints[1], dataPoints[3], "AC_CYPHER", helpers);
    if (n >= 5) drawDiagonalWithRatio(pixelPoints[2], pixelPoints[4], dataPoints[2], dataPoints[3], dataPoints[4], "BD_CYPHER", helpers);
    if (n >= 5) drawDiagonalWithRatio(pixelPoints[0], pixelPoints[4], dataPoints[0], dataPoints[3], dataPoints[4], "XD_CYPHER", helpers);
    ctx.restore();
