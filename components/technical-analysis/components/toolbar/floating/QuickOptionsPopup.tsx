...
const ReadOnlyOptionState = ({ label, value }: { label: string; value: string }) => (
    <div className="d-flex justify-content-between align-items-center" aria-readonly="true">
    ...
    return (
        <div style={{ minWidth: "180px", color: "#131722" }}>
            ...
            {drType === "fib_speed_resistance_arcs" && dr.fibSpeedResistanceArcsProps && (
                <>
                    <ReadOnlyOptionState label="Niveaux" value="Actifs" />
