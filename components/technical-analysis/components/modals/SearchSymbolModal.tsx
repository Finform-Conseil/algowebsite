...
import { addComparisonSymbol, removeComparisonSymbol, selectUiState, selectChartConfig } from "../../store/technicalAnalysisSlice";
    ...
    return (
      ...
      >
        <div style={{
          ...
          <span style={{ color: "#9aa4b2", fontSize: 10, fontWeight: 700 }}>{security.ticker.slice(0, 2)}</span>
          {security.logoUrl && (
            <img
