...
/**
 * Interface pour les données par pays
 */
...
type AfricaFIMapProps = {
  data: Record<string, CountryInfo>;
  mode: "performance" | "count";
  onCountryClick: (countryId: string, countryData?: CountryInfo) => void;
};

const AfricaFIMap: React.FC<AfricaFIMapProps> = ({
  data,
  mode,
  onCountryClick,
}) => {
  ...
  const getCountryColor = (countryId: string) => {
    ...
    if (!countryData) return "var(--card-background, #f3f4f6)";

    if (mode === "performance") {
      const perf = countryData.bestPerformance;
      if (perf < 0) {
        // Dégradé de rouge pour perf négative (intensité max à -10%)
        const intensity = Math.min(Math.abs(perf) / 10, 1);
        return `rgba(239, 68, 68, ${0.3 + intensity * 0.7})`;
      } else {
        // Dégradé de vert pour perf positive (intensité max à +20%)
        const intensity = Math.min(perf / 20, 1);
        return `rgba(16, 185, 129, ${0.3 + intensity * 0.7})`;
      }
    } else {
      // Mode "count" : Dégradé d'orange basé sur le volume le plus haut reçu
  ...
  /**
   * Style commun pour les pays cliquables (ceux qui ont de la donnée)
   */
  const getCountryStyle = (countryId: string) => {
    const hasData = !!data[countryId];
    return {
  ...
  const handlePathClick = (countryId: string) => {
    if (data[countryId]) {
      onCountryClick(countryId, data[countryId]);
    } else {
      // On peut quand même retourner le clic même sans données
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Liste exhaustive des chemins SVG de l'Afrique */}
        <path
          id="AO"
          data-name="Angola"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("AO")}
          onClick={() => handlePathClick("AO")}
        />
        <path
          id="BI"
          data-name="Burundi"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("BI")}
          onClick={() => handlePathClick("BI")}
        />
        <path
          id="BJ"
          data-name="Benin"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("BJ")}
          onClick={() => handlePathClick("BJ")}
        />
        <path
          id="BF"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("BF")}
          onClick={() => handlePathClick("BF")}
        />
        <path
          id="BW"
          data-name="Botswana"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("BW")}
          onClick={() => handlePathClick("BW")}
        />
        <path
          id="CF"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("CF")}
          onClick={() => handlePathClick("CF")}
        />
        <path
          id="CI"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("CI")}
          onClick={() => handlePathClick("CI")}
        />
        <path
          id="CM"
          data-name="Cameroon"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("CM")}
          onClick={() => handlePathClick("CM")}
        />
        <path
          id="CD"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("CD")}
          onClick={() => handlePathClick("CD")}
        />
        <path
          id="CG"
          data-name="Congo"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("CG")}
          onClick={() => handlePathClick("CG")}
        />
        <path
          id="DJ"
          data-name="Djibouti"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("DJ")}
          onClick={() => handlePathClick("DJ")}
        />
        <path
          id="DZ"
          data-name="Algeria"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("DZ")}
          onClick={() => handlePathClick("DZ")}
        />
        <path
          id="EG"
          data-name="Egypt"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("EG")}
          onClick={() => handlePathClick("EG")}
        />
        <path
          id="ER"
          data-name="Eritrea"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("ER")}
          onClick={() => handlePathClick("ER")}
        />
        <path
          id="ET"
          data-name="Ethiopia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("ET")}
          onClick={() => handlePathClick("ET")}
        />
        <path
          id="GA"
          data-name="Gabon"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("GA")}
          onClick={() => handlePathClick("GA")}
        />
        <path
          id="GH"
          data-name="Ghana"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("GH")}
          onClick={() => handlePathClick("GH")}
        />
        <path
          id="GN"
          data-name="Guinea"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("GN")}
          onClick={() => handlePathClick("GN")}
        />
        <path
          id="GM"
          data-name="Gambia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("GM")}
          onClick={() => handlePathClick("GM")}
        />
        <path
          id="GW"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("GW")}
          onClick={() => handlePathClick("GW")}
        />
        <path
          id="GQ"
          data-name="Eq. Guinea"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("GQ")}
          onClick={() => handlePathClick("GQ")}
        />
        <path
          id="KE"
          data-name="Kenya"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("KE")}
          onClick={() => handlePathClick("KE")}
        />
        <path
          id="LR"
          data-name="Liberia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("LR")}
          onClick={() => handlePathClick("LR")}
        />
        <path
          id="LY"
          data-name="Libya"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("LY")}
          onClick={() => handlePathClick("LY")}
        />
        <path
          id="LS"
          data-name="Lesotho"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("LS")}
          onClick={() => handlePathClick("LS")}
        />
        <path
          id="MA"
          data-name="Morocco"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("MA")}
          onClick={() => handlePathClick("MA")}
        />
        <path
          id="MG"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("MG")}
          onClick={() => handlePathClick("MG")}
        />
        <path
          id="ML"
          data-name="Mali"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("ML")}
          onClick={() => handlePathClick("ML")}
        />
        <path
          id="MZ"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("MZ")}
          onClick={() => handlePathClick("MZ")}
        />
        <path
          id="MR"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("MR")}
          onClick={() => handlePathClick("MR")}
        />
        <path
          id="MW"
          data-name="Malawi"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("MW")}
          onClick={() => handlePathClick("MW")}
        />
        <path
          id="NA"
          data-name="Namibia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("NA")}
          onClick={() => handlePathClick("NA")}
        />
        <path
          id="NE"
          data-name="Niger"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("NE")}
          onClick={() => handlePathClick("NE")}
        />
        <path
          id="NG"
          data-name="Nigeria"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("NG")}
          onClick={() => handlePathClick("NG")}
        />
        <path
          id="RW"
          data-name="Rwanda"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("RW")}
          onClick={() => handlePathClick("RW")}
        />
        <path
          id="EH"
          data-name="W. Sahara"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("EH")}
          onClick={() => handlePathClick("EH")}
        />
        <path
          id="SD"
          data-name="Sudan"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("SD")}
          onClick={() => handlePathClick("SD")}
        />
        <path
          id="SS"
          data-name="S. Sudan"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("SS")}
          onClick={() => handlePathClick("SS")}
        />
        <path
          id="SN"
          data-name="Senegal"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("SN")}
          onClick={() => handlePathClick("SN")}
        />
        <path
          id="SL"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("SL")}
          onClick={() => handlePathClick("SL")}
        />
        <path
          id="SZ"
          data-name="Swaziland"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("SZ")}
          onClick={() => handlePathClick("SZ")}
        />
        <path
          id="TD"
          data-name="Chad"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("TD")}
          onClick={() => handlePathClick("TD")}
        />
        <path
          id="TG"
          data-name="Togo"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("TG")}
          onClick={() => handlePathClick("TG")}
        />
        <path
          id="TN"
          data-name="Tunisia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("TN")}
          onClick={() => handlePathClick("TN")}
        />
        <path
          id="TZ"
          data-name="Tanzania"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("TZ")}
          onClick={() => handlePathClick("TZ")}
        />
        <path
          id="UG"
          data-name="Uganda"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("UG")}
          onClick={() => handlePathClick("UG")}
        />
        <path
          id="ZA"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="2"
          style={getCountryStyle("ZA")}
          onClick={() => handlePathClick("ZA")}
        />
        <path
          id="ZM"
          data-name="Zambia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("ZM")}
          onClick={() => handlePathClick("ZM")}
        />
        <path
          id="ZW"
          data-name="Zimbabwe"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("ZW")}
          onClick={() => handlePathClick("ZW")}
        />
        <path
          id="SO"
          data-name="Somalia"
          ...
          stroke="var(--border-color, #ffffff)"
          strokeWidth="1.5"
          style={getCountryStyle("SO")}
          onClick={() => handlePathClick("SO")}
        />
      </svg>
    </div>
  );
