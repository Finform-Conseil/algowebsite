...
export default function MTPSecondaryScreenerPage() {
  ...
  const insights = useMemo(() => {
    ...
    const avgSpread =
      filteredBonds.reduce((sum, b) => sum + b.spread, 0) /
      filteredBonds.length;
    const totalVolume = filteredBonds.reduce(
      (sum, b) => sum + b.totalVolumeTraded,
      0,
    );
              ...
              <div className="range-inputs">
                <input
                  ...
                  onChange={(e) =>
                    setFilters({
                      ...filters,
                      ytmRange: [Number(e.target.value), filters.ytmRange[1]],
                    })
                  }
                  placeholder="Min"
                />
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFilters({
                      ...filters,
                      ytmRange: [filters.ytmRange[0], Number(e.target.value)],
                    })
                  }
                  placeholder="Max"
                />
                  ...
                  {filteredBonds.map((bond) => (
                    ...
                    >
                      ...
                      <td className="isin-col">
                        <Link
                          href={`/fixed-income/bond-detail/mtp-secondary/${bond.isin}`}
                          className="isin-link"
                        >
                          {bond.isin}
                        </Link>
                ...
                <tbody>
                  {filteredBonds.map((bond) => (
                    ...
                    >
                      ...
                      <td className="number-col">
                        {(bond.nominalVolumeTraded / 1000000).toFixed(0)}M
                      </td>
                      <td className="number-col">
                        {(bond.accruedInterest / 1000000).toFixed(0)}M
                      </td>
                      <td className="number-col">
                        {(bond.totalVolumeTraded / 1000000).toFixed(0)}M
                      </td>
                      <td className="number-col">
                        {(bond.exchangeRatio * 100).toFixed(1)}%
                      </td>
                ...
                <tbody>
                  {filteredBonds.map((bond) => (
                    ...
                    >
                      ...
                      <td className="number-col">{bond.maxPrice.toFixed(2)}</td>
                      <td className="number-col">
                        {bond.lastTransactionPrice.toFixed(2)}
                      </td>
                      <td className="number-col highlight">
                        {bond.proposedPrice.toFixed(2)}
                      </td>
                      <td className="number-col">{bond.quantity}</td>
                      <td className="number-col">
                        {bond.accruedCoupon.toFixed(2)}
