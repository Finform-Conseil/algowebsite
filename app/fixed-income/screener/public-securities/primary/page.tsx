...
export default function MTPScreenerPage() {
  ...
  const filteredBonds = useMemo(() => {
    return mockBonds.filter((bond) => {
      ...
      if (
        bond.couponRate < filters.couponRange[0] ||
        bond.couponRate > filters.couponRange[1]
      ) {
        return false;
      }
  ...
  const insights = useMemo(() => {
    ...
    const avgYTM =
      filteredBonds.reduce((sum, b) => sum + b.ytm, 0) / filteredBonds.length;
    if (avgYTM > 6) {
      results.push({
        type: "positive",
    ...
    const highCouponCount = filteredBonds.filter(
      (b) => b.couponRate > 6,
    ).length;
    ...
    const shortTermCount = filteredBonds.filter(
      (b) => b.residualDuration < 2,
    ).length;
    if (shortTermCount > 0) {
      results.push({
        type: "info",
    ...
    const upcomingOSTCount = filteredBonds.filter(
      (b) => b.upcomingOST !== "None",
    ).length;
              ...
              <div className="multi-selects">
                ...
                <MultiSelect
                  ...
                  onChange={(compartments) =>
                    setFilters((prev) => ({ ...prev, compartments }))
                  }
                ...
                <MultiSelect
                  ...
                  onChange={(bondTypes) =>
                    setFilters((prev) => ({ ...prev, bondTypes }))
                  }
                ...
                <div className="range-inputs">
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((prev) => ({
                        ...prev,
                        ytmRange: [Number(e.target.value), prev.ytmRange[1]],
                      }))
                    }
                  />
                  <span>-</span>
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((prev) => ({
                        ...prev,
                        ytmRange: [prev.ytmRange[0], Number(e.target.value)],
                      }))
                    }
                  />
                </div>
                ...
                {filteredBonds.map((bond) => (
                  ...
                  >
                    ...
                    <td className="isin-col">
                      <Link
                        href={`/fixed-income/bond-detail/mtp-primary/${bond.isin}`}
                        className="isin-link"
                      >
                        {bond.isin}
                      </Link>
                    ...
                    <td className="number-col">
                      {(bond.outstandingAmount / 1000000).toFixed(0)}M
                    </td>
                    <td className="number-col">{bond.issuePrice.toFixed(2)}</td>
                    <td className="number-col">
                      {bond.marketPrice.toFixed(2)}
                    </td>
                    <td
                      className={`number-col ${bond.spread >= 0 ? "positive" : "negative"}`}
                    >
                    ...
                    <td>
                      <span className="badge badge-ost">
                        {bond.upcomingOST}
                      </span>
                    </td>
              ...
              <tbody>
                {filteredBonds.map((bond) => (
                  ...
                  >
                    ...
                    <td>
                      {new Date(bond.ostDate).toLocaleDateString("en-US")}
                    </td>
                    <td className="actions-col">
                      <button className="btn-action btn-opportunity">
                        <svg
              ...
              <tbody>
                {filteredBonds.map((bond) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="badge badge-coupon-type">
                        {bond.couponType}
                      </span>
                    </td>
                    <td className="number-col">{bond.couponRate.toFixed(2)}</td>
                    ...
                    <td>
                      {new Date(bond.previousCouponDate).toLocaleDateString(
                        "en-US",
                      )}
                    </td>
                    <td>
              ...
              <tbody>
                {filteredBonds.map((bond) => (
                  ...
                  >
                    ...
                    <td className="number-col">
                      {(bond.requestedAmount / 1000000).toFixed(0)}M
                    </td>
                    <td className="number-col">
                      {(bond.totalSubmissions / 1000000).toFixed(0)}M
                    </td>
                    <td className="number-col">
                      {bond.submissionCoverageRatio.toFixed(2)}x
                    </td>
                    <td className="number-col">
                      {(bond.retainedSubmissions / 1000000).toFixed(0)}M
                    </td>
                    <td className="number-col">
                      {bond.retainedCoverageRatio.toFixed(2)}x
                    </td>
                    <td className="number-col">
                      {bond.absorptionRate.toFixed(1)}
                    </td>
                    <td className="number-col">
                      {bond.weightedAvgPrice.toFixed(2)}
                    </td>
                    <td className="number-col">
                      {bond.marginalPrice.toFixed(2)}
                    </td>
              ...
              <tbody>
                {filteredBonds.map((bond) => (
                  ...
                  >
                    ...
                    <td>
                      <span className="badge badge-operation">
                        {bond.operationType}
                      </span>
                    </td>
                    <td>{bond.simultaneous}</td>
                    <td className="number-col">
                      {(bond.amount / 1000000).toFixed(0)}M
                    </td>
                    <td className="number-col">
