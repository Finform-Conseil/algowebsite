...
export const MARKET_STOCKS: Stock[] = [
  ...
  { ticker: 'SONATEL', name: 'Sonatel', exchange: 'BRVM', sector: 'Telecom', price: 18500, currency: 'XOF', change: 7.2, changeValue: 1240, volume: 38000, avgVolume: 28000, marketCap: 185000000000, open: 17260, high: 18700, low: 17200, sparklineData: generateSparkline(18500, 0.025), lastUpdate: new Date() },
  ...
  { ticker: 'TTLS', name: 'Total Sénégal', exchange: 'BRVM', sector: 'Energy', price: 2450, currency: 'XOF', change: 4.5, changeValue: 105, volume: 68000, avgVolume: 48000, marketCap: 24500000000, open: 2345, high: 2480, low: 2330, sparklineData: generateSparkline(2450, 0.022), lastUpdate: new Date() },
  
  // JSE - Top performers
  { ticker: 'NPN', name: 'Naspers', exchange: 'JSE', sector: 'Technology', price: 3250, currency: 'ZAR', change: 9.2, changeValue: 274, volume: 1250000, avgVolume: 980000, marketCap: 1400000000000, open: 2976, high: 3280, low: 2950, sparklineData: generateSparkline(3250, 0.035), lastUpdate: new Date() },
  { ticker: 'AGL', name: 'Anglo American Platinum', exchange: 'JSE', sector: 'Materials', price: 1580, currency: 'ZAR', change: 7.8, changeValue: 114, volume: 890000, avgVolume: 720000, marketCap: 420000000000, open: 1466, high: 1595, low: 1455, sparklineData: generateSparkline(1580, 0.032), lastUpdate: new Date() },
  ...
  { ticker: 'MTN', name: 'MTN Group', exchange: 'JSE', sector: 'Telecom', price: 92, currency: 'ZAR', change: 5.2, changeValue: 4.55, volume: 3200000, avgVolume: 2500000, marketCap: 168000000000, open: 87.45, high: 93.5, low: 87, sparklineData: generateSparkline(92, 0.025), lastUpdate: new Date() },
  { ticker: 'VOD', name: 'Vodacom', exchange: 'JSE', sector: 'Telecom', price: 128, currency: 'ZAR', change: 4.8, changeValue: 5.86, volume: 1850000, avgVolume: 1500000, marketCap: 192000000000, open: 122.14, high: 129.5, low: 121.8, sparklineData: generateSparkline(128, 0.023), lastUpdate: new Date() },
  
  // NGX - Top performers
  { ticker: 'DANGCEM', name: 'Dangote Cement', exchange: 'NGX', sector: 'Materials', price: 285, currency: 'NGN', change: 8.9, changeValue: 23.3, volume: 4500000, avgVolume: 3200000, marketCap: 4850000000000, open: 261.7, high: 288, low: 260, sparklineData: generateSparkline(285, 0.034), lastUpdate: new Date() },
  { ticker: 'MTNN', name: 'MTN Nigeria', exchange: 'NGX', sector: 'Telecom', price: 245, currency: 'NGN', change: 7.5, changeValue: 17.1, volume: 5200000, avgVolume: 4100000, marketCap: 5010000000000, open: 227.9, high: 248, low: 226, sparklineData: generateSparkline(245, 0.031), lastUpdate: new Date() },
  { ticker: 'BUACEMENT', name: 'BUA Cement', exchange: 'NGX', sector: 'Materials', price: 98, currency: 'NGN', change: 6.2, changeValue: 5.72, volume: 3800000, avgVolume: 2900000, marketCap: 2940000000000, open: 92.28, high: 99.5, low: 91.8, sparklineData: generateSparkline(98, 0.027), lastUpdate: new Date() },
  
  // Flops - BRVM
  { ticker: 'PALM', name: 'Palmci', exchange: 'BRVM', sector: 'Industry', price: 5800, currency: 'XOF', change: -6.5, changeValue: -403, volume: 28000, avgVolume: 22000, marketCap: 58000000000, open: 6203, high: 6250, low: 5750, sparklineData: generateSparkline(5800, 0.03), lastUpdate: new Date() },
  { ticker: 'NESTLE', name: 'Nestlé CI', exchange: 'BRVM', sector: 'Consumer', price: 6200, currency: 'XOF', change: -5.8, changeValue: -382, volume: 32000, avgVolume: 25000, marketCap: 62000000000, open: 6582, high: 6600, low: 6150, sparklineData: generateSparkline(6200, 0.028), lastUpdate: new Date() },
  { ticker: 'CFAO', name: 'CFAO Motors CI', exchange: 'BRVM', sector: 'Industry', price: 720, currency: 'XOF', change: -4.9, changeValue: -37, volume: 45000, avgVolume: 38000, marketCap: 7200000000, open: 757, high: 765, low: 715, sparklineData: generateSparkline(720, 0.025), lastUpdate: new Date() },
  
  // Flops - JSE
  { ticker: 'ANG', name: 'AngloGold Ashanti', exchange: 'JSE', sector: 'Materials', price: 285, currency: 'ZAR', change: -7.2, changeValue: -22.1, volume: 1450000, avgVolume: 1200000, marketCap: 119000000000, open: 307.1, high: 310, low: 282, sparklineData: generateSparkline(285, 0.032), lastUpdate: new Date() },
  { ticker: 'IMP', name: 'Impala Platinum', exchange: 'JSE', sector: 'Materials', price: 142, currency: 'ZAR', change: -6.8, changeValue: -10.3, volume: 980000, avgVolume: 850000, marketCap: 118000000000, open: 152.3, high: 154, low: 140, sparklineData: generateSparkline(142, 0.03), lastUpdate: new Date() },
  { ticker: 'SSW', name: 'Sibanye Stillwater', exchange: 'JSE', sector: 'Materials', price: 38, currency: 'ZAR', change: -5.5, changeValue: -2.21, volume: 2200000, avgVolume: 1900000, marketCap: 110000000000, open: 40.21, high: 40.5, low: 37.5, sparklineData: generateSparkline(38, 0.028), lastUpdate: new Date() },
  ...
  { ticker: 'AIRTEL', name: 'Airtel Africa', exchange: 'NGX', sector: 'Telecom', price: 1850, currency: 'NGN', change: 2.1, changeValue: 38, volume: 8500000, avgVolume: 6200000, marketCap: 6920000000000, open: 1812, high: 1865, low: 1805, sparklineData: generateSparkline(1850, 0.018), lastUpdate: new Date() },
...
export const generateInsights = (stocks: Stock[]): MarketInsight[] => {
  ...
  if (bestSector) {
    insights.push({
      ...
      description: `${bestSector.sector}: +${bestSector.avg.toFixed(2)}% average`,
      severity: 'success',
      icon: 'bar-chart',
      data: bestSector
    });
  ...
  if (highVolumeStocks.length > 0) {
    insights.push({
      id: 'volume',
      type: 'volume',
      title: 'Abnormal Volumes Detected',
      description: `${highVolumeStocks.length} stock(s) with volume > 2x average`,
      severity: 'warning',
      icon: 'activity',
